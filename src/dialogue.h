...
std::string talk_needs[num_needs][5] = {
	...
	{
		"Hey<punc> You got any <ammo>?",
		"I'll need some <ammo> soon, got any?",
		"I really need some <ammo><punc>",
		"I need <ammo> for my <mywp>, got any?",
	...
	},
	{
		...
		"<ill_die> without something to drink.",
