	...
	switch (type) {
		...
		case PLTYPE_STUDENT:
			switch (rng(1, 12)) {
				...
				case 8:
				case 9:
					if (!has_trait(PF_SAVANT)) return PF_FASTLEARNER;
				case 10:
					return PF_INCONSPICUOUS;
				case 11:
					return PF_LIGHTSTEP;
				case 12:
					if (one_in(3)) return PF_ANDROID;
					else return PF_FASTLEARNER;
			}
		case PLTYPE_FARMER:
			switch (rng(1, 18)) {
				case 1:
	...
	switch (type) {
		...
		case PLTYPE_STUDENT:
			switch (rng(1, 19)) {
				...
				case 17:
				case 18:
					if (!has_trait(PF_FASTLEARNER)) return PF_SAVANT;
				case 19:
		...
		case PLTYPE_COP:
			switch (rng(1, 11)) {
				...
				case 8:
					return PF_TRIGGERHAPPY;
				case 9:
					if (one_in(3)) return PF_SCHIZOPHRENIC;
					else return PF_INSOMNIA;
				case 10:
					return PF_JITTERY;
				case 11:
