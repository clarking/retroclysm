...
bool connects_to(overmap_terrain_id there, int dir_from_here);
...
void map::generate(game *g, overmap *om, int x, int y, int turn) {
	overmap_terrain_id terrain_type, t_north, t_east, t_south, t_west, t_above;
	int overx = x / 2;
	int overy = y / 2;
...
void map::draw_map(overmap_terrain_id terrain_type, overmap_terrain_id t_north, overmap_terrain_id t_east,
...
bool connects_to(overmap_terrain_id there, int dir) {
	switch (dir) {
		case 2:
