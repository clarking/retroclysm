...
// GENERAL GUIDELINES
// When adding a new item, you MUST REMEMBER to insert it in the itype_id enum at the top of itype.h!
//  Additionally, you should check mapitemsdef.cpp and insert the new item in any appropriate lists.
...
void game::init_itypes() {
	...
	itypes.push_back( new itype(1, 0, 0, "corpse", "A dead body.", '%', c_white, MNULL, MNULL, 0, 0, 0, 0, 0));
	int index = 1;
