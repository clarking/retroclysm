...
// overmap_terrain defines almost all data needed to describe a location... however,
...
// Order MUST match enum overmap_terrain_id above!

const overmap_terrain oterlist[num_ter_types] = {
	{"nothing",              '%',  c_white,   0},
	{"field",                '.',  c_brown,   2},
	{"forest",               'F',  c_green,   3},
	{"forest",               'F',  c_green,   4},
