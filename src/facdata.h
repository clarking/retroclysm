...
std::string faction_adj_pos[15] = {
	...
	"Splendid", "Divine", "Radiant", "Noble", "Venerable", "Immaculate", "Heroic", "Bright"};
...
faction_value_datum facgoal_data[NUM_FACGOALS] = {
	...
	{"the cultivation of knowledge",  2,  -3, -1, -1, 0},
...
faction_value_datum facval_data[NUM_FACVALS] = {
	...
	{"exploring extensively",      1,  0,  0,  -2, -1},
	{"collecting rare artifacts",  0,  1,  1,  -1, 3},
	...
	{"treachery",                  -3, 0,  1,  3,  0},
	{"the avoidance of drugs",     1,  0,  0,  -2, 1},
...
// Note:
// It's nice to keep the totals around 0 for Good, and about even for the other four.
// It's okay if Good is slightly negative (after all, in a post-apocalyptic world people might be a LITTLE less virtuous),
// and to keep strength valued a bit higher than the others.
